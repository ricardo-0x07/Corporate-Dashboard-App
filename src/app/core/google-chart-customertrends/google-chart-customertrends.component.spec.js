...
/* eslint-env jasmine */
'use strict';
describe('googleChartCustomertrends', function() {
    // Load the module that contains the `googleChartCustomertrends` component before each test
    beforeEach(angular.mock.module('core.googleChartCustomertrends'));
    // Test the controller
    describe('GoogleChartCustomerTrendsController', function() {
        ...
        beforeEach(function() {
            ...
            angular.mock.inject(function(_$componentController_) {
                ...
                ctrl = $componentController('googleChartCustomertrends');
        ...
        it('should create a chart of type LineChart', function() {
            expect(ctrl.chart.type).toBe('LineChart');
        });
